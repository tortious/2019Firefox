...
// @note toolbar button for opening the passwords in a window
// ==/UserScript==
...
oncommand: "window.open('chrome://passwordmgr/content/passwordManager.xhtml', 'Toolkit:PasswordManager', 'chrome,resizable=yes');"
};
for (var p in props)
